...
<?php
    ...
    $key = $_GET['key'];
    $query = "SELECT * FROM `movie` WHERE `m_name` like '%$key%' OR `m_genre` like '%$key%' OR `m_year`='$key'";
...
<html lang="en">
    ...
    <div class="container">
        <div class="col-md-6">
                <div class="profile-head text-light">
                    <h5 class="text-uppercase">
                        <?php echo $key ?> Movies
                    </h5>
            </div>
            <hr class="my-3" style="color: #ED0A0A;">
        </div>
        <div class="container">
                        ...
                        <div class="col-md-4 my-2">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body bg-secondary text-light">
                                    <h5 class="card-title"><a class="text-decoration-none text-light" href="individualMovie.php?id=<?php echo $row['m_id'] ?>"><?php echo $row['m_name'] ?></a></h5>
                                    <p class="card-text-"><?php echo substr($row['m_description'], 0, 50) . '...'; ?></p>
                                </div>
                                <div class="card-footer bg-secondary">
                                    <small class="text-warning fw-bold"><?php echo $row['m_price']." Taka" ?></small>
                                </div>
